...
#: Шаг внутреннего цикла ожидания, с.
#:
#: Определяет точность выдержки периода телеметрии: кадр выходит на ближайшем
#: тике, поэтому шаг в 5 мс давал при заданных 20 мс фактические ~23 мс.
#: Два миллисекунды — компромисс между точностью и холостой работой цикла;
#: на реальной плате период выдерживает её собственный таймер, и это ограничение
#: относится только к режиму симуляции.
_TICK_INTERVAL = 0.002
